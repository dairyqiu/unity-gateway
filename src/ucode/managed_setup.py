...
def supports_provider_service(tool: str, provider_type: str) -> bool:
    ...
    obvious place to ask. Only claude (anthropic / amazon_bedrock) and codex (openai /
    amazon_bedrock) have MPS support today; the other harnesses are Databricks-hosted only.
    """
